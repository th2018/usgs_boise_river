...
plot(lucky_qt$date, lucky_qt$luc_qt,main="QT Totalled Average Discharge, cfs" )
plot(lucky_qt$date, lucky_qt$log_median_Q ,main="log_median_Q" )
plot(lucky_qt$date, lucky_qt$mean_StreamTemp ,main="mean_StreamTemp" )
```
